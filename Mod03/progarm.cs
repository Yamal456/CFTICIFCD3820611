...
public class Program
{
  ...
  public static async Task Main(string[] args)
  {
      ...
      BlobContainerClient containerClient= await GetContainerClientAsync(serviceClient, newContainerName);
  ...
  GetContainerClientAsync(BlobServiceClient client, string containerName)
  {
      BlobContainerClient container = client.GetBlobContainerClient(containerName);
